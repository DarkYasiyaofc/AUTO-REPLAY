...
if (fs.existsSync('./lib/Sakura/' + Config.LANG + '.json')) {	
	//log(pint('Loading ' + Config.LANG + ' language...', '.'));	
	var json = JSON.parse(fs.readFileSync('./lib/Sakura/' + Config.LANG + '.json'));	
} else {	
	var json = JSON.parse(fs.readFileSync('./lib/Sakura/EN.json'));
}	
